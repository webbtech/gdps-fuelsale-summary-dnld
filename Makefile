...
build: clean
	@for dir in `ls handler`; do \
		GOOS=linux go build -o dist/$$dir github.com/pulpfree/gdps-fs-sum-dwnld/handler/$$dir; \
	done
	@GOOS=linux go build -o dist/authorizer github.com/pulpfree/gdps-fs-sum-dwnld/authorizer;
